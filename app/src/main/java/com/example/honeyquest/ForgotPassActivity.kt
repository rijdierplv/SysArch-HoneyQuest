    ...
    class ForgotPassActivity : AppCompatActivity() {
        ...
        private var isConfirmNewPassVisible = false
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            val toggleConfirmNewPassBtn = findViewById<ImageButton>(R.id.toggleConfirmNewPassBtn)
            ...
            toggleNewPassBtn.setOnClickListener {
                ...
                if (isNewPassVisible) {
                    ...
                    toggleNewPassBtn.setImageResource(R.drawable.eye_open)
                } else {
                    newPasswordInput.inputType = InputType.TYPE_CLASS_TEXT or InputType.TYPE_TEXT_VARIATION_PASSWORD
                    toggleNewPassBtn.setImageResource(R.drawable.eye_closed)
                }

                newPasswordInput.setSelection(newPasswordInput.text.length)
            }

            toggleConfirmNewPassBtn.setOnClickListener {
                isConfirmNewPassVisible = !isConfirmNewPassVisible

                if (isConfirmNewPassVisible) {
                    confirmNewPasswordInput.inputType = InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD
                    toggleConfirmNewPassBtn.setImageResource(R.drawable.eye_open)
                } else {
                    confirmNewPasswordInput.inputType = InputType.TYPE_CLASS_TEXT or InputType.TYPE_TEXT_VARIATION_PASSWORD
                    toggleConfirmNewPassBtn.setImageResource(R.drawable.eye_closed)
                }
